...
import de.culo.lucyo.model.DetailsDescriptionPresenter;
...
import de.culo.lucyo.Utils;
import de.culo.lucyo.opa.OpaActivity;

/*
 * LeanbackDetailsFragment extends DetailsFragment, a Wrapper fragment for leanback details screens.
 * It shows a detailed view of video and its meta plus related videos.
 */
public class OpaDetailsFragment extends DetailsFragment {
    private static final String TAG = "OpaDetailsFragment";
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        mSelectedMovie = (Movie) getActivity().getIntent()
                .getSerializableExtra(OpaDetailsActivity.MOVIE);
        if (mSelectedMovie != null) {
            ...
            Intent intent = new Intent(getActivity(), OpaActivity.class);
    ...
    private void setupDetailsOverviewRowPresenter() {
        ...
        detailsPresenter.setSharedElementEnterTransition(
                getActivity(),
                OpaDetailsActivity.SHARED_ELEMENT_NAME
        );
        ...
        detailsPresenter.setOnActionClickedListener(new OnActionClickedListener() {
            ...
            public void onActionClicked(Action action) {
                if (action.getId() == ACTION_WATCH_TRAILER) {
                    ...
                    intent.putExtra(OpaDetailsActivity.MOVIE, mSelectedMovie);
                    startActivity(intent);
                } else {
    ...
    private final class ItemViewClickedListener implements OnItemViewClickedListener {
        ...
        public void onItemClicked(Presenter.ViewHolder itemViewHolder, Object item,
            ...
            if (item instanceof Movie) {
                ...
                Intent intent = new Intent(getActivity(), OpaDetailsActivity.class);

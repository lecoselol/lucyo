...
public interface ImageReceiver {
    ...
    /**
     * See https://developers.google.com/android/reference/com/google/android/gms/vision/Frame.Builder.html#setImageData(java.nio.ByteBuffer, int, int, int)
     */
    void newImageReceived(ByteBuffer data, int width, int height, int format);
}

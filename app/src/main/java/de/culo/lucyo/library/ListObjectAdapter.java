...
public class ListObjectAdapter<T> extends ObjectAdapter {

    private final List<T> items;

    public ListObjectAdapter(Presenter presenter, List<T> items) {
        super(presenter);
        this.items = items;
    }

    public ListObjectAdapter(PresenterSelector presenterSelector, List<T> items) {

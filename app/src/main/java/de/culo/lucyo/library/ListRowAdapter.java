...
public class ListRowAdapter extends ObjectAdapter {

    private List<ListRow> rowsList = new ArrayList<>();

    public ListRowAdapter(List<ListRow> rowsList, Presenter presenter) {
        super(presenter);

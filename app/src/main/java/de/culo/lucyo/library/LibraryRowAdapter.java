...
public class LibraryRowAdapter extends ObjectAdapter {

    private List<MoviePoster> posters;

    public LibraryRowAdapter(List<MoviePoster> posters, Presenter presenter) {
        super(presenter);
    ...
    @Override
    public MoviePoster get(int position) {
